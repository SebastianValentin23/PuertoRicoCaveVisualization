...
<html>
	...
	<body class="is-preload">
		<div id="page-wrapper">
			...
			<nav id="nav">
					<ul>
						<li class="current"><a href="admin-cave-creation.php">Cave Creation</a></li>
                        <?php
				...
				<div class="container">
					...
					<!-- Content -->
						<article>
							...
							<form id="caveForm">
								<h3>Cave Name:</h3>
								<input type="text" id="caveName" name="caveName">
								<br>			
								<h3>Town</h3>
								<select id="town" name="town">
									...
									<option value="Town C">Ponce</option>
								</select>
								<br><br>
								<h4>Biodiversity:</h4>
								<fieldset>
								...
								<br>
								<h4>Exploration Date</h4>
								<input type="date" id="exploration-date">
								<br>
								<br>
								<fieldset>	
									<div>
										...
										<div class="file-input-container">
											...
											<input type="file" id="caveSize" name="caveSize" class="file-input">
